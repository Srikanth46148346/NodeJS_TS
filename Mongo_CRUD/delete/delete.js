...
remove.delete('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, db, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                _a.sent();
                db = client.db(dbName);
                return [4 /*yield*/, db.collection('products').deleteOne({ _id: new mongodb_1.ObjectId(productId) })];
            case 3:
                result = _a.sent();
